...
JNI Binding for Global Domination
...
* It combines all these into gdom-android.jar, which you can use in your Android projects.
...
The resulting libraries (gdomjni.dll, gdomjni.lib) are created in bindings/jni/msvc/bin.
